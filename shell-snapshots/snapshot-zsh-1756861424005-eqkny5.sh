...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/home/caio/.claude/local/node_modules/\@anthropic-ai/claude-code/vendor/ripgrep/x64-linux/rg'
fi
export PATH=/home/linuxbrew/.linuxbrew/bin\:/home/linuxbrew/.linuxbrew/sbin\:/home/caio/.local/bin\:/tmp/.mount_CursorA4trxE/usr/bin/\:/tmp/.mount_CursorA4trxE/usr/sbin/\:/tmp/.mount_CursorA4trxE/usr/games/\:/tmp/.mount_CursorA4trxE/bin/\:/tmp/.mount_CursorA4trxE/sbin/\:/usr/local/sbin\:/usr/local/bin\:/usr/bin\:/opt/cuda/bin\:/opt/cuda/nsight_compute\:/opt/cuda/nsight_systems/bin\:/usr/lib/jvm/default/bin\:/usr/bin/site_perl\:/usr/bin/vendor_perl\:/usr/bin/core_perl\:/opt/rocm/bin
