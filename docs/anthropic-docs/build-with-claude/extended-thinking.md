...
- On 3rd-party platforms (e.g., [Amazon Bedrock](https://docs.anthropic.com/en/api/claude-on-amazon-bedrock) and [Vertex AI](https://docs.anthropic.com/en/api/claude-on-vertex-ai)), if you pass `interleaved-thinking-2025-05-14` to any model aside from Claude Opus 4.1, Opus 4, or Sonnet 4, your request will fail.
